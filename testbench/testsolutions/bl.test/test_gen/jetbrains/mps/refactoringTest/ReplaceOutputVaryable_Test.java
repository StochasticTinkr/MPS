...
public class ReplaceOutputVaryable_Test extends BaseTransformationTest {
  ...
  public void test_ReplaceOutputVaryableTest() throws Throwable {
    runTest("jetbrains.mps.refactoringTest.ReplaceOutputVaryable_Test$TestBody", "test_ReplaceOutputVaryableTest", true);
  }
  ...
  public static class TestBody extends BaseTestBody {
    public void test_ReplaceOutputVaryableTest() throws Exception {
      ...
      {
        List<SNode> nodesBefore = ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(getNodeById("8155843501977560794"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8c108ca66L, "ClassConcept"))));
        List<SNode> nodesAfter = ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(getNodeById("8155843501977560874"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8c108ca66L, "ClassConcept"))));
