...
public class ExtractWithStaticFieldReference_Test extends BaseTransformationTest {
  ...
  public void test_extractFromStatements() throws Throwable {
    runTest("jetbrains.mps.refactoringTest.ExtractWithStaticFieldReference_Test$TestBody", "test_extractFromStatements", true);
  }
  ...
  public static class TestBody extends BaseTestBody {
    public void test_extractFromStatements() throws Exception {
      ...
      ref.doRefactor();
      {
        List<SNode> nodesBefore = ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(getNodeById("7475692990584681434"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8c108ca66L, "ClassConcept"))));
        List<SNode> nodesAfter = ListSequence.fromListAndArray(new ArrayList<SNode>(), SNodeOperations.cast(getNodeById("7475692990584681454"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8c108ca66L, "ClassConcept"))));
