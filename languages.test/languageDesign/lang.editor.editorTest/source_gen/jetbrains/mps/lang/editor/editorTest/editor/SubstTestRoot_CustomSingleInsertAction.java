...
public class SubstTestRoot_CustomSingleInsertAction {
  public static void setCellActions(EditorCell editorCell, SNode node, EditorContext context) {
    editorCell.setAction(CellActionType.INSERT, new SubstTestRoot_CustomSingleInsertAction.SubstTestRoot_CustomSingleInsertAction_INSERT(node));
  }
  public static class SubstTestRoot_CustomSingleInsertAction_INSERT extends AbstractCellAction {
    /*package*/ SNode myNode;
    public SubstTestRoot_CustomSingleInsertAction_INSERT(SNode node) {
      this.myNode = node;
    }
