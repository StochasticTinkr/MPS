...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForSideTransformInfo() {
    ...
    b.version(2);
    b.property("side", 0xad0053c7aee2321L).type(MetaIdFactory.enumerationId(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0xad0053c7aee25ecL)).origin("779128492853699361").done();
  ...
  private static ConceptDescriptor createDescriptorForSuppressErrorsAnnotation() {
    ...
    b.version(2);
    b.property("whichError", 0x21a1b53c6f2a72edL).type(PrimitiveTypeId.STRING).origin("2423417345669755629").done();
    return b.create();
  }
}
