...
public class ConceptAncestors_Finder extends GeneratedFinder {
  private static final Logger LOG = LogManager.getLogger(ConceptAncestors_Finder.class);
  ...
  protected void doFind0(@NotNull SNode node, SearchScope scope, IFinder.FindCallback callback, ProgressMonitor monitor) {
    try {
      ...
      if (concept == null) {
        ...
        SModule module = check_l1y5zg_a0g0b0a(check_l1y5zg_a0a6a1a0(node));
        if (module != null) {
  ...
  public SNodeReference getDeclarationNode() {
    return buildNodePointer(FindUsagesDescriptor.DECLARING_MODEL, "6869265041613396010");
  }
  private static SModule check_l1y5zg_a0g0b0a(SModel checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getModule();
    }
    return null;
  }
  private static SModel check_l1y5zg_a0a6a1a0(SNode checkedDotOperand) {
    if (null != checkedDotOperand) {
