...
public class ConceptDescendants_Finder extends GeneratedFinder {
  private static final Logger LOG = LogManager.getLogger(ConceptDescendants_Finder.class);
  ...
  protected void doFind0(@NotNull SNode node, SearchScope scope, IFinder.FindCallback callback, ProgressMonitor monitor) {
    try {
      ...
      if (concept == null) {
        ...
        SModule module = check_d8q4lz_a0f0b0a(check_d8q4lz_a0a5a1a0(node));
        if (module != null) {
  ...
  private static SModule check_d8q4lz_a0f0b0a(SModel checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getModule();
    }
    return null;
  }
  private static SModel check_d8q4lz_a0a5a1a0(SNode checkedDotOperand) {
    if (null != checkedDotOperand) {
