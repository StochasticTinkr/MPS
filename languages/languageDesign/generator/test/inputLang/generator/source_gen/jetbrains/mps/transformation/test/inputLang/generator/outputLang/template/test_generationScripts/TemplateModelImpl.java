...
public class TemplateModelImpl extends TemplateModelBase implements TemplateModel2 {
  ...
  public TemplateDeclaration loadTemplate(TemplateDeclarationKey key) {
    ...
    if (template.equals(new SNodePointer("r:00000000-0000-4000-0000-011c895905f6(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_generationScripts@generator)", "1195166061402"))) {
      return new Template_OutputRoot_By_RootRule();
    }
    if (template.equals(new SNodePointer("r:00000000-0000-4000-0000-011c895905f6(jetbrains.mps.transformation.test.inputLang.generator.outputLang.template.test_generationScripts@generator)", "1195168984336"))) {
      return new Template_OutputRoot_by_MappingRule();
    }
    return null;
  }
}
