              ...
              TemplateContext context4 = context3.subContext();
              {
                ...
                try {
                  TemplateContext context5 = context4.subContext();
                  {
                    ...
                    final Object varValue11 = QueriesGenerated.insertMacro_varValue_50150722796367611030(new TemplateVarContext(context5, varMacroRef_xizpik_b0a0a1a1a1a1a1a3a1a5a1a4));
                    ...
                    try {
                      ...
                      }
                      {
                        ...
                        try {
                          SNodeAccessUtil.setProperty(tnode14, myProperties[1], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_50150722796367611060(new PropertyMacroContext(context7, "0", propertyMacro_xizpik_c0a0c0a0b0e0e0b0b0b0b0d0b0f0b0e))));
                        } finally {
                        }
