...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a0e1a5 = new String[]{"jetbrains.mps.lang.editor.editor.PropertyDeclarationCellSelector_Empty_SideTransformMenu"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0f1a5 = new String[]{"jetbrains.mps.lang.editor.editor.addExtendedClass_StyleClass"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0g1a5 = new String[]{"jetbrains.mps.lang.editor.editor.SubstituteMenuReference_Default_QueryMenu"};
