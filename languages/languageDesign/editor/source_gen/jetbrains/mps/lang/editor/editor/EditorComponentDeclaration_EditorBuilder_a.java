...
/*package*/ class EditorComponentDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class overridenEditorComponentSingleRoleHandler_qbcy69_b1b1a extends SingleRoleCellProvider {
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xfb35c2bb47L, 0x619d955714550434L, "overridenEditorComponent"));
      }
    }
    @Override
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new EditorComponentDeclaration_EditorBuilder_a.contextHintsListHandler_qbcy69_b1b2a(myNode, getEditorContext());
  ...
  private static class contextHintsListHandler_qbcy69_b1b2a extends RefNodeListHandler {
    ...
    public contextHintsListHandler_qbcy69_b1b2a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return MetaAdapterFactory.getContainmentLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xfb35c2bb47L, 0x65fc2f4f98189976L, "contextHints");
    }
      ...
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new EditorComponentDeclaration_EditorBuilder_a.Inline_Builder_qbcy69_a1b1d0(getEditorContext(), getNode(), targetNode).createCell();
          }
