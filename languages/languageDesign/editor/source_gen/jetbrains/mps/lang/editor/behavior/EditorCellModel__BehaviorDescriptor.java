...
public final class EditorCellModel__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getTopAncestorCellModel_idM76vXnqh08 = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getTopAncestorCellModel").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("M76vXnqh08").registry(REGISTRY).build();
