...
public class Mapping_mc_pointer_operations extends MapConfigBase implements TemplateMappingConfiguration {
  ...
  public final class ReductionRule0 extends ReductionRuleBase implements TemplateRuleWithCondition {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      {
        final SNode switchInput1 = QueriesGenerated.sourceNodeQuery_130_0(new SourceSubstituteMacroNodeContext(context, switchMacroRef_bhg3pv_b0a0a0a2a2d));
        if (switchInput1 == null) {
          ...
          TemplateContext switchContext1;
          {
            ...
            args1.put("pointer", ((SNode) QueriesGenerated.templateArgumentQuery_130_0(new TemplateArgumentContext(context, new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "4065387505485823567")))));
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      try {
        ...
        TemplateContext context1 = context.subContext();
        {
          ...
          final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_130_1(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_bhg3pv_b0a0c0d0c0c4));
