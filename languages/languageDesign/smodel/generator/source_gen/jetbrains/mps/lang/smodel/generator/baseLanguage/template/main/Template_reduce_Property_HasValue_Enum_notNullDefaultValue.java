...
public class Template_reduce_Property_HasValue_Enum_notNullDefaultValue extends TemplateDeclarationBase implements TemplateDeclaration2 {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_136_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_9qfqxb_b0a0c0d0c0g));
      ...
      }
      {
        ...
        SNode callInputNode4 = QueriesGenerated.sourceNodeQuery_136_1(new SourceSubstituteMacroNodeContext(context1, callMacro_9qfqxb_b0a0a1a4a2a6));
      ...
      }
      {
        ...
        final SNode copySrcInput6 = QueriesGenerated.sourceNodeQuery_136_2(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_9qfqxb_b0a0c0f0c0g));
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode8, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_136_0(new PropertyMacroContext(context1, "_default_value_", propertyMacro_9qfqxb_c0a0c0a0b0g0c0g))));
        } finally {
        }
  ...
  private static SNodePointer callMacro_9qfqxb_b0a0a1a4a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "633481135935145287");
