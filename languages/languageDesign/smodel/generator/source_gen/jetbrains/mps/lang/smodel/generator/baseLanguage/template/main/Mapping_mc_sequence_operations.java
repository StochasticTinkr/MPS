...
public class Mapping_mc_sequence_operations extends MapConfigBase implements TemplateMappingConfiguration {
  ...
  public boolean isApplicable(@NotNull ITemplateGenerator generator) {
    return QueriesGenerated.mappingConfiguration_Condition_rk0ups_a(new TemplateQueryContext(getMappingNode(), generator));
  }
  @Override
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      try {
        ...
        TemplateContext context1 = context.subContext();
        {
          ...
          final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_39023543336545241230(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_jil9eh_b0a0c0d0c0c4));
        ...
        }
        {
          ...
          {
            final SNode switchInput4 = QueriesGenerated.sourceNodeQuery_39023543336545241310(new SourceSubstituteMacroNodeContext(context1, switchMacroRef_jil9eh_b0a0a0a1a4a2a2e));
