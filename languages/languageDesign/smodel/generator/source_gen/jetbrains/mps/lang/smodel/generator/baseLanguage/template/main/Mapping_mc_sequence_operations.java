...
public class Mapping_mc_sequence_operations extends MapConfigBase implements TemplateMappingConfiguration {
  ...
  public boolean isApplicable(@NotNull ITemplateGenerator generator) {
    return QueriesGenerated.mc_Condition_68(new TemplateQueryContext(getMappingNode(), generator));
  }
  @Override
  ...
  public final class ReductionRule0 extends ReductionRuleBase implements TemplateRuleWithCondition {
    ...
    public boolean isApplicable(@NotNull TemplateContext context) throws GenerationException {
      return QueriesGenerated.rule_Condition_68_0(new ReductionRuleQueryContext(context, getRuleNode()));
    }
    @Override
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      try {
        ...
        TemplateContext context1 = context.subContext();
        {
          ...
          final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_68_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_jil9eh_b0a0c0d0c0c4));
        ...
        }
        {
          ...
          {
            final SNode switchInput4 = QueriesGenerated.sourceNodeQuery_68_1(new SourceSubstituteMacroNodeContext(context1, switchMacroRef_jil9eh_b0a0a0a1a4a2a2e));
