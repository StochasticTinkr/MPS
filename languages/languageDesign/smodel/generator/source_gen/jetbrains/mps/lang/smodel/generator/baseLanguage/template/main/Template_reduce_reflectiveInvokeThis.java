  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        SNode callInputNode2 = QueriesGenerated.sourceNodeQuery_115_0(new SourceSubstituteMacroNodeContext(context1, callMacro_f0s0cy_b0a0a1a3a2a5));
      ...
      }
      {
        ...
        try {
          ...
          TemplateContext context3 = context1.subContext();
          {
            ...
            try {
              SNodeAccessUtil.setProperty(tnode6, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_115_0(new PropertyMacroContext(context3, "foo", propertyMacro_f0s0cy_c0a0c0a0b0d0b0f0c0f))));
            } finally {
            }
          ...
          }
          {
            ...
            if (QueriesGenerated.ifMacro_Condition_115_0(new IfMacroContext(context3, ifMacroRef_f0s0cy_b0a0b0e0b0f0c0f))) {
          ...
          }
          {
            ...
            try {
              SNodeAccessUtil.setProperty(tnode11, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_115_1(new PropertyMacroContext(context3, "1234567890", propertyMacro_f0s0cy_c0a0c0a0b0f0b0f0c0f))));
            } finally {
            }
      ...
      }
      {
        ...
        tlist12 = new Template_reduce_Parameters().apply(context1, ((SNode) QueriesGenerated.templateArgumentQuery_115_0(new TemplateArgumentContext(context1, new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3099391750892236517")))));
