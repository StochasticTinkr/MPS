...
@Generated
public class Template_reduce_GetAncestor_whereConceptInList_SameML extends TemplateDeclarationBase {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.ifMacro_Condition_21117621374011709800(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_nv63xn_b0a0c0d0c0f));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_nv63xn_b0a0c0d0c0f, "tpl/r:00000000-0000-4000-0000-011c89590303/2111762137401170980", context1);
          ...
          TemplateContext context2 = context1.subContext();
          {
            ...
            try {
              ...
              }
              {
                ...
                final Iterable<SNode> loopList7 = QueriesGenerated.sourceNodesQuery_a0a0b0_0(new SourceSubstituteMacroNodesContext(context3, loopMacroRef_nv63xn_b0a0a1a2a1a1a1a4a2a5));
                for (SNode itnode7 : loopList7) {
                  ...
                  SNode callInputNode8 = QueriesGenerated.ifMacro_Condition_39023543336538014490(new SourceSubstituteMacroNodeContext(context4, includeMacro_nv63xn_b0a0a3a2a2a1a1a1a4a2a5));
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode10, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_21117621374011710040(new PropertyMacroContext(context1, null, propertyMacro_nv63xn_c0a0c0a0b0f0c0f))));
        } finally {
        }
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode11, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_21117621374011710130(new PropertyMacroContext(context1, null, propertyMacro_nv63xn_c0a0c0a0b0g0c0f))));
        } finally {
        }
  ...
  private static SNodePointer copySrcMacro_nv63xn_b0a0c0d0c0f = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2111762137401170981");
  private static SNodePointer loopMacroRef_nv63xn_b0a0a1a2a1a1a1a4a2a5 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333653806869");
  private static SNodePointer includeMacro_nv63xn_b0a0a3a2a2a1a1a1a4a2a5 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333653814673");
  private static SNodePointer propertyMacro_nv63xn_c0a0c0a0b0f0c0f = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2111762137401171005");
  private static SNodePointer propertyMacro_nv63xn_c0a0c0a0b0g0c0f = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2111762137401171014");
}
