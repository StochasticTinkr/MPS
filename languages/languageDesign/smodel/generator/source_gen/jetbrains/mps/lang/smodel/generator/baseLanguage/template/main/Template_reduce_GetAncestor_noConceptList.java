  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_35_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_lwwzp9_b0a0c0d0c0g));
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode6, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_35_0(new PropertyMacroContext(context1, null, propertyMacro_lwwzp9_c0a0c0a0b0f0c0g))));
        } finally {
        }
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode7, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_35_1(new PropertyMacroContext(context1, null, propertyMacro_lwwzp9_c0a0c0a0b0g0c0g))));
        } finally {
        }
