...
@Generated
public class Template_reduce_SPropertyAccess_enum extends TemplateDeclarationBase {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_25_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_402ndg_b0a0c0d0c0f));
      ...
      }
      {
        ...
        SNode callInputNode4 = QueriesGenerated.sourceNodeQuery_25_1(new SourceSubstituteMacroNodeContext(context1, includeMacro_402ndg_b0a0a1a4a2a5));
      ...
      }
      {
        ...
        if (QueriesGenerated.ifMacro_Condition_25_0(new IfMacroContext(context1, ifMacroRef_402ndg_b0a0b0f0c0f))) {
          final SNode tnode7 = environment.createOutputNode(myConcepts[1]);
          try {
            SNodeAccessUtil.setProperty(tnode7, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_25_0(new PropertyMacroContext(context1, "_default_value_", propertyMacro_402ndg_c0a0c0a0b0b0f0c0f))));
          } finally {
          }
  ...
  private static SNodePointer copySrcMacro_402ndg_b0a0c0d0c0f = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1146249898891");
  private static SNodePointer includeMacro_402ndg_b0a0a1a4a2a5 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6506750610319607771");
  private static SNodePointer propertyMacro_402ndg_c0a0c0a0b0b0f0c0f = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1146250029818");
  private static SNodePointer ifMacroRef_402ndg_b0a0b0f0c0f = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1195247677816");
}
