...
@Generated
public class Template_reduce_SPropertyAccess_simple extends TemplateDeclarationBase implements TemplateDeclaration2 {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_2_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_dkiczw_b0a0c0d0c0g));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_dkiczw_b0a0c0d0c0g, "tpl/r:00000000-0000-4000-0000-011c89590303/1139275804870", context1);
      ...
      }
      {
        ...
        SNode callInputNode4 = QueriesGenerated.sourceNodeQuery_2_1(new SourceSubstituteMacroNodeContext(context1, includeMacro_dkiczw_b0a0a1a4a2a6));
  ...
  private static SNodePointer copySrcMacro_dkiczw_b0a0c0d0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1139275804871");
  private static SNodePointer includeMacro_dkiczw_b0a0a1a4a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6506750610319369366");
}
