    ...
    try {
      TemplateContext context1 = context.subContext();
      {
        ...
        try {
          ...
          SNodeAccessUtil.setProperty(tnode2, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_3_1(new PropertyMacroContext(context1, "createNode", propertyMacro_synbg_c0a0c0b0b0b0c0f))));
          TemplateContext context2 = context1.subContext();
          {
            final List<SNode> tlist3 = new ArrayList<SNode>();
            final Iterable<SNode> loopList3 = QueriesGenerated.sourceNodesQuery_3_0(new SourceSubstituteMacroNodesContext(context2, loopMacroRef_synbg_b0a0a1a3a1a1a2a5));
            int loopIndex_c_3 = 0;
            for (SNode itnode3 : loopList3) {
              ...
              try {
                SNodeAccessUtil.setProperty(tnode4, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_3_0(new PropertyMacroContext(context3, "a", propertyMacro_synbg_c0a0c0a0e0d0d0b0b0c0f))));
          ...
          }
          {
            ...
            try {
              TemplateContext context5 = context2.subContext();
              {
                ...
                if (QueriesGenerated.ifMacro_Condition_3_0(new IfMacroContext(context5, ifMacroRef_synbg_b0a0b0b0b0g0b0b0c0f))) {
              ...
              }
              {
                ...
                final SNode copySrcInput20 = QueriesGenerated.sourceNodeQuery_3_0(new SourceSubstituteMacroNodeContext(context5, copySrcMacro_synbg_b0a0c0d0b0g0b0b0c0f));
      ...
      }
      {
        ...
        try {
          ...
          TemplateContext context11 = context1.subContext();
          {
            ...
            final Iterable<SNode> loopList25 = QueriesGenerated.sourceNodesQuery_3_1(new SourceSubstituteMacroNodesContext(context11, loopMacroRef_synbg_b0a0a1a2a1a2a2a5));
