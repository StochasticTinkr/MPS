...
public class Switch_switch_ClassFromType extends TemplateSwitchBase implements TemplateSwitchMapping {
      ...
      }
      {
        ...
        try {
          ...
          TemplateContext context4 = context1.subContext();
          {
            ...
            final SNode copySrcInput7 = QueriesGenerated.sourceNodeQuery_5176512338944756060(new SourceSubstituteMacroNodeContext(context4, copySrcMacro_ef4au6_b0a0c0c0b0c0b0f));
      ...
      try {
        environment.resolve(new RefResolver(tnode1, MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x103fb730c14L, 0x103fb73a43eL, "classifier"), context, new SNodePointer("r:229ce18d-2bb0-4d5b-a7cd-cec65841e459(jetbrains.mps.lang.behavior.generator.template.main@generator)", "517651233894479652"), "Byte") {
          ...
          public Object resolve() {
            return QueriesGenerated.referenceMacro_GetReferent_23569493416159736570(createQueryContext());
          }
        });
      } finally {
      }
  ...
  public final class ReductionRule2 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      final SNode copySrcInput1 = QueriesGenerated.sourceNodeQuery_23569493416162728160(new SourceSubstituteMacroNodeContext(context, copySrcMacro_ef4au6_b0a0d0b9));
  ...
  public final class ReductionRule3 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      Collection<SNode> tlist1 = null;
      {
        final SNode switchInput1 = QueriesGenerated.sourceNodeQuery_46984110995152039650(new SourceSubstituteMacroNodeContext(context, switchMacroRef_ef4au6_b0a0a0a2a1k));
  ...
  public final class ReductionRule4 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      final TemplateExecutionEnvironment environment = context.getEnvironment();
      Collection<SNode> tlist1 = null;
      final SNode copySrcInput1 = QueriesGenerated.sourceNodeQuery_71545498075402119890(new SourceSubstituteMacroNodeContext(context, copySrcMacro_ef4au6_b0a0d0b11));
