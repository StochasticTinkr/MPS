...
/*package*/ class NamedTupleDeclaration_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_955wzk_0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_955wzk_0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new NamedTupleDeclaration_InspectorBuilder_a.annotationListHandler_955wzk_b0(myNode, getEditorContext());
  ...
  private static class annotationListHandler_955wzk_b0 extends RefNodeListHandler {
    ...
    public annotationListHandler_955wzk_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(annotationListHandler_955wzk_b0.this.getNode(), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x114a6be947aL, 0x114a6beb0bdL, "annotation")));
      try {
