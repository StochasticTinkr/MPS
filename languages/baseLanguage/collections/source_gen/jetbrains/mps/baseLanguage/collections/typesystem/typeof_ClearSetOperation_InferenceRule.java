...
public class typeof_ClearSetOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode elementType_typevar_1226934681270 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) _quotation_createNode_econfx_a0a2a1a1(typeCheckingContext.getRepresentative(elementType_typevar_1226934681270)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1226934649738", true), false, true, _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1226934695674", true), (SNode) _quotation_createNode_econfx_a1a2a2a1(), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_econfx_a0a2a1a1(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_econfx_a1a2a2a1() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
