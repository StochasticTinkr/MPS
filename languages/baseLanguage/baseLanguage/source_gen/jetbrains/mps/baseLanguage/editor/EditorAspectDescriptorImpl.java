...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase implements EditorHintsProvider {
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a0fb1a7 = new String[]{"jetbrains.mps.baseLanguage.editor.AddBoundToTypeVariableDeclaration"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0gb1a7 = new String[]{"jetbrains.mps.baseLanguage.editor.ArrayAndGenericTypesFromTypesInVarDeclarations", "jetbrains.mps.baseLanguage.editor.VariableDeclaration_ApplySideTransforms", "jetbrains.mps.baseLanguage.editor.variableDeclarationInitializer"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0hb1a7 = new String[]{"jetbrains.mps.baseLanguage.editor.LocalInstanceFieldReference_Transform", "jetbrains.mps.baseLanguage.editor.convertVariableAssignmentToVarDeclaration"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0ib1a7 = new String[]{"jetbrains.mps.baseLanguage.editor.Visibility_ext_1_RTransform_Menu", "jetbrains.mps.baseLanguage.editor.addAbstract", "jetbrains.mps.baseLanguage.editor.addGenericTypeDeclaration"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0jb1a7 = new String[]{"jetbrains.mps.baseLanguage.editor.WildCardType_ApplySideTransforms"};
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a0f1a9 = new String[]{"jetbrains.mps.baseLanguage.editor.StaticFieldInClassifier", "jetbrains.mps.baseLanguage.editor.ctor_IncompleteMember", "jetbrains.mps.baseLanguage.editor.ctor_IncompleteMemberInInterface", "jetbrains.mps.baseLanguage.editor.ctor_InterfaceMemberBasedOnIncomplete", "jetbrains.mps.baseLanguage.editor.ctor_MemberBasedOnIncomplete"};
