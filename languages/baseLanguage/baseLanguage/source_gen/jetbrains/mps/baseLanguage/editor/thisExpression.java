...
public class thisExpression extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new thisExpression.SMP_Group_bo5td7_a());
    return result;
  }
  ...
  public class SMP_Group_bo5td7_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts() {
      return Arrays.<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>asList(new ConstraintsFilteringSubstituteMenuPartDecorator(new thisExpression.SMP_Group_bo5td7_a.SMP_Param_bo5td7_a0(), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf93d4da00cL, "jetbrains.mps.baseLanguage.structure.ThisExpression")));
    }
    private class SMP_Param_bo5td7_a0 extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
      ...
      protected List<SubstituteMenuItem> createItems(SNode parameter, SubstituteMenuContext context) {
        return new thisExpression.SMP_Group_bo5td7_a.SMP_Param_bo5td7_a0.SMP_Action_bo5td7_a0a(parameter).createItems(context);
      }
      @NotNull
      @Override
      public List<SubstituteMenuItem> createItems(@NotNull SubstituteMenuContext context) {
      ...
      private class SMP_Action_bo5td7_a0a extends SingleItemSubstituteMenuPart {
        ...
        protected SubstituteMenuItem createItem(SubstituteMenuContext _context) {
          thisExpression.SMP_Group_bo5td7_a.SMP_Param_bo5td7_a0.SMP_Action_bo5td7_a0a.Item item = new thisExpression.SMP_Group_bo5td7_a.SMP_Param_bo5td7_a0.SMP_Action_bo5td7_a0a.Item(_context);
          String description;
          try {
        ...
        private class Item extends DefaultSubstituteMenuItem {
          ...
          public Item(SubstituteMenuContext context) {
            super(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf93d4da00cL, "jetbrains.mps.baseLanguage.structure.ThisExpression"), context.getParentNode(), context.getCurrentTargetNode(), context.getEditorContext());
            _context = context;
          }
          ...
          public SNode createNode(@NotNull String pattern) {
            SNode thisEx = SNodeFactoryOperations.createNewNode(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf93d4da00cL, "jetbrains.mps.baseLanguage.structure.ThisExpression"), null);
