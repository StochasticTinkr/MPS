...
public class ifStatement extends TransformationMenuBase {
    ...
    private class TMP_Param_dmkm09_a0a extends ParameterizedMenuPart<String, TransformationMenuItem, TransformationMenuContext> {
      ...
      private class TMP_Action_dmkm09_a0a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
        ...
        protected TransformationMenuItem createItem(TransformationMenuContext context) {
          ifStatement.TMP_Group_dmkm09_a0.TMP_Param_dmkm09_a0a.TMP_Action_dmkm09_a0a0.Item item = new ifStatement.TMP_Group_dmkm09_a0.TMP_Param_dmkm09_a0a.TMP_Action_dmkm09_a0a0.Item(context);
          String description;
          try {
  ...
  private class TMP_Param_dmkm09_b0 extends ParameterizedMenuPart<String, TransformationMenuItem, TransformationMenuContext> {
    ...
    private class TMP_Action_dmkm09_a1a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      @Nullable
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        ifStatement.TMP_Param_dmkm09_b0.TMP_Action_dmkm09_a1a.Item item = new ifStatement.TMP_Param_dmkm09_b0.TMP_Action_dmkm09_a1a.Item(context);
        String description;
        try {
          description = "single item: " + item.getLabelText("");
        } catch (Throwable t) {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        @Override
        public void execute(@NotNull String pattern) {
          SNode elseIf = SNodeFactoryOperations.addNewChild(_context.getNode(), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b217L, 0x118cecf1287L, "elsifClauses"), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x118ceceb41aL, "jetbrains.mps.baseLanguage.structure.ElsifClause"));
