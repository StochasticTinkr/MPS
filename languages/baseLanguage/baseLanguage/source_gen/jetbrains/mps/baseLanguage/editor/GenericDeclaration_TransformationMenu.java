  ...
  public class TMP_Group_wdgok2_a1 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class TMP_Action_wdgok2_a0b extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        GenericDeclaration_TransformationMenu.TMP_Group_wdgok2_a1.TMP_Action_wdgok2_a0b.Item item = new GenericDeclaration_TransformationMenu.TMP_Group_wdgok2_a1.TMP_Action_wdgok2_a0b.Item(context);
        String description;
        try {
        ...
        context.getEditorMenuTrace().pushTraceInfo();
        try {
          context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586940745")));
