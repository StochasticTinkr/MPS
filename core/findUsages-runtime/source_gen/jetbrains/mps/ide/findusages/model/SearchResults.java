...
public class SearchResults<T> implements UsagesList {
  private final SearchedObjects<?> mySearchedObjects; // better would be a type
  ...
  public static SearchResults union(@NotNull SearchResults one, @NotNull SearchResults another) {
    ...
    List<SearchResult> searchResults = Stream.concat(((List<SearchResult>)one.getSearchResults()).stream(),
                                                     ((List<SearchResult>) another.getSearchResults()).stream())
  ...
  public List<SearchResult<?>> getNotNullResults() {
    List<SearchResult<?>> alive = new ArrayList<>();
