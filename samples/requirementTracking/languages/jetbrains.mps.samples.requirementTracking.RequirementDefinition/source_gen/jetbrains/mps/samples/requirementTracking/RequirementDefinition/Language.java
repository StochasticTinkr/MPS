...
import jetbrains.mps.samples.requirementTracking.RequirementDefinition.typesystem.TypesystemDescriptor;
...
public class Language extends LanguageRuntime {
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == ConstraintsAspectDescriptor.class) {
      return aspectClass.cast(new jetbrains.mps.samples.requirementTracking.RequirementDefinition.constraints.ConstraintsAspectDescriptor());
    }
