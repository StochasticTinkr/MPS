...
public class Template_reduce_RoutineDefinition extends TemplateDeclarationBase {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      SNodeAccessUtil.setProperty(tnode2, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetPropertyValue_33083005030397012130(new PropertyMacroContext(context1, "bar", propertyMacro_9qqvr5_c0a0c0a0e0f))));
      ...
      }
      {
        ...
        try {
          TemplateContext context3 = context2.subContext();
          {
            ...
            final SNode copySrcInput6 = QueriesGenerated.ifMacro_Condition_33083005030399070170(new SourceSubstituteMacroNodeContext(context3, copySrcMacro_9qqvr5_b0a0c0b0b0e0e0f));
