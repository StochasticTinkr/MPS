...
public class GoToImplementingBehaviorMethod_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    GoToHelper.executeFinders(event.getData(MPSCommonDataKeys.NODE), event.getData(MPSCommonDataKeys.MPS_PROJECT), GoToImplementingBehaviorMethod_Action.this.calcTitle(event.getData(MPSCommonDataKeys.MPS_PROJECT), event.getData(MPSCommonDataKeys.NODE), event), FindUtils.getFinder("jetbrains.mps.lang.behavior.findUsages.ImplementingMethods_Finder"), GoToContextMenuUtil.getRelativePoint(selectedCell, inputEvent));
  }
