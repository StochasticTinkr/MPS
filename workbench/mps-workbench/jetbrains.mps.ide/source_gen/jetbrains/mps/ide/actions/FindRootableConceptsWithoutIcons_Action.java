      ...
      public void run(@NotNull ProgressIndicator p0) {
        ...
        modelAccess.runReadAction(new Runnable() {
          public void run() {
            ...
            IWhereFilter<SearchResult<Object>> iWhereFilter = new IWhereFilter<SearchResult<Object>>() {
              public boolean accept(SearchResult<Object> it) {
                SNode node = (SNode) it.getObject();
                return SPropertyOperations.getBoolean(node,
                                                      MetaAdapterFactory.getProperty(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xf979ba0450L, 0xff49c1d648L,
                                                                                     "rootable")) && (SLinkOperations.getTarget(node,
