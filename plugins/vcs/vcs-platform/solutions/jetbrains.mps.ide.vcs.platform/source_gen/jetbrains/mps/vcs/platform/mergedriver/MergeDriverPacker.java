...
public abstract class MergeDriverPacker {
  ...
  private static final Iterable<String> ideaLibJars = Arrays.asList("asm-all-7.0-beta.jar", "xstream-1.4.8.jar", "guava-17.0.jar", "jdom.jar", "log4j.jar", "trove4j.jar", "annotations.jar");
