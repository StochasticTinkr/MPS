...
SET BITS=64
SET USER_JDK64_FILE=%USERPROFILE%\.MPS2018.3\config\mps%BITS%.exe.jdk
SET BITS=
SET USER_JDK_FILE=%USERPROFILE%\.MPS2018.3\config\mps%BITS%.exe.jdk
...
IF NOT EXIST "%VM_OPTIONS_FILE%" (
  :: user-overridden
  SET VM_OPTIONS_FILE=%USERPROFILE%\.MPS2018.3\config\mps%BITS%.exe.vmoptions
)
IF NOT EXIST "%VM_OPTIONS_FILE%" (
...
SET IDEA_PATHS_SELECTOR=MPS2018.3
