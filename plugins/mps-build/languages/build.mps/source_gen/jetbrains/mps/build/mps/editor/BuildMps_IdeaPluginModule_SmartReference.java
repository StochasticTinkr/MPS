...
public class BuildMps_IdeaPluginModule_SmartReference extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new BuildMps_IdeaPluginModule_SmartReference.SMP_ReferenceScope_wbo7rb_a(), MetaAdapterFactory.getConcept(0xcf935df46994e9cL, 0xa132fa109541cba3L, 0x5b7be37b4de9bbdcL, "jetbrains.mps.build.mps.structure.BuildMps_IdeaPluginModule")));
    return result;
  }
  ...
  public class SMP_ReferenceScope_wbo7rb_a extends ReferenceScopeSubstituteMenuPart {
    ...
    protected ReferenceScopeSubstituteMenuItem createItem(SubstituteMenuContext context, SNode referencedNode) {
      return new BuildMps_IdeaPluginModule_SmartReference.SMP_ReferenceScope_wbo7rb_a.Item(context, referencedNode, getSConcept(), getReferenceLink());
    }
