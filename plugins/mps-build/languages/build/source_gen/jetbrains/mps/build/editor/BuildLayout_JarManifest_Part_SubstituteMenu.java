  ...
  public class SMP_Group_aabwkk_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    public class SMP_Group_aabwkk_a0 extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
      ...
      private class SMP_Action_aabwkk_a0a extends SingleItemSubstituteMenuPart {
        ...
        protected SubstituteMenuItem createItem(SubstituteMenuContext _context) {
          BuildLayout_JarManifest_Part_SubstituteMenu.SMP_Group_aabwkk_a.SMP_Group_aabwkk_a0.SMP_Action_aabwkk_a0a.Item item = new BuildLayout_JarManifest_Part_SubstituteMenu.SMP_Group_aabwkk_a.SMP_Group_aabwkk_a0.SMP_Action_aabwkk_a0a.Item(_context);
          String description;
          try {
        ...
        private class Item extends DefaultSubstituteMenuItem {
          ...
          public SNode createNode(@NotNull String pattern) {
            SNode section = SNodeFactoryOperations.createNewNode(_context.getModel(), MetaAdapterFactory.getConcept(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0x115d3b22faf47d7bL, "jetbrains.mps.build.structure.BuildLayout_JarManifest_Section"), null);
            SNodeFactoryOperations.setNewChild(section, MetaAdapterFactory.getContainmentLink(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0x115d3b22faf47d7bL, 0x5ee439f214c0c758L, "name"), MetaAdapterFactory.getConcept(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0xbabdfbeee17fe57L, "jetbrains.mps.build.structure.BuildStringNotEmpty"));
            return section;
          }
    ...
    public class SMP_Group_aabwkk_b0 extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
      ...
      private class SMP_Action_aabwkk_a1a extends SingleItemSubstituteMenuPart {
        ...
        @Override
        protected SubstituteMenuItem createItem(SubstituteMenuContext _context) {
          BuildLayout_JarManifest_Part_SubstituteMenu.SMP_Group_aabwkk_a.SMP_Group_aabwkk_b0.SMP_Action_aabwkk_a1a.Item item = new BuildLayout_JarManifest_Part_SubstituteMenu.SMP_Group_aabwkk_a.SMP_Group_aabwkk_b0.SMP_Action_aabwkk_a1a.Item(_context);
          String description;
          try {
            description = "Substitute item: " + item.getMatchingText("");
          } catch (Throwable t) {
        ...
        private class Item extends DefaultSubstituteMenuItem {
          ...
          @Override
          public SNode createNode(@NotNull String pattern) {
            SNode newInitializedNode = SNodeFactoryOperations.createNewNode(_context.getModel(), MetaAdapterFactory.getConcept(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0x115d3b22faf20f30L, "jetbrains.mps.build.structure.BuildLayout_JarManifest_Attribute"), null);
            String name;
            String value = null;
            if (pattern.contains(":")) {
