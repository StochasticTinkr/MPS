...
public class GoToOverridenClassMethod_Action extends BaseAction {
  private static final Icon ICON = null;

  public GoToOverridenClassMethod_Action() {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    return (GoToOverridenClassMethod_Action.this.getInstanceMethodDeclaration(_params) != null) && (GoToOverridenClassMethod_Action.this.getClassifier(_params) != null);
  }
  @Override
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    Task.Backgroundable task = new Task.Backgroundable(((Project) MapSequence.fromMap(_params).get("project")), "Searching...", true, PerformInBackgroundOption.ALWAYS_BACKGROUND) {
      ...
      public void onSuccess() {
        ...
        GoToContextMenuUtil.showNodeMenu(((MPSProject) MapSequence.fromMap(_params).get("mpsProject")), title, methods, new DefaultMethodRenderer(((MPSProject) MapSequence.fromMap(_params).get("mpsProject")).getRepository()), relativePoint);
      }
    };
  ...
  private SNode getClassifier(final Map<String, Object> _params) {
    return SNodeOperations.getNodeAncestor(GoToOverridenClassMethod_Action.this.getInstanceMethodDeclaration(_params), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101d9d3ca30L, "jetbrains.mps.baseLanguage.structure.Classifier"), false, false);
  }
  private Set<Tuples._2<SNodeReference, SNode>> getOverridenMethod(final Map<String, Object> _params) {
    SNode method = GoToOverridenClassMethod_Action.this.getInstanceMethodDeclaration(_params);
    SNode classifier = GoToOverridenClassMethod_Action.this.getClassifier(_params);
    ...
    if (enumConstant != null) {
      overridenMethods = new OverridingMethodsFinder(SNodeOperations.cast(classifier, MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfc367070a5L, "jetbrains.mps.baseLanguage.structure.EnumClass")), enumConstant).getOverriddenMethods(method);
    } else {
      overridenMethods = new OverridingMethodsFinder(classifier, Sequence.<SNode>singleton(method)).getOverriddenMethods(method);
    }
