...
public class GoToOverridingClassMethod_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    SNode methodNode = (SNode) MapSequence.fromMap(_params).get("methodNode");
    MPSProject project = (MPSProject) MapSequence.fromMap(_params).get("project");
    GoToHelper.showPopupAndSearchNodeInBackground(methodNode, project, GoToOverridingClassMethod_Action.this.calcTitle(
        project,
        methodNode, _params), FindUtils.getFinder("jetbrains.mps.baseLanguage.findUsages.DerivedMethods_Finder"),
